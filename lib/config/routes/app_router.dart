...
import '../../features/advising/presentation/advising_oversight_screen.dart';
    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: '/admin/advising', pageBuilder: (c,s) => slideRightPage(const AdvisingOversightScreen(), s)),
