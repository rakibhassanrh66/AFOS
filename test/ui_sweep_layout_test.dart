...
void main() {
  runLayoutSweep('ui sweep', expectTruncated: {
    ...
    // The normal path, and the one every single applicant sees. Probed because
    // it just gained the "Paste code from email" control below an already tall
    // stack — a heading, an address that can be long, a 6-digit field at
    // display size, the paste button, the confirm button and two text links.
    'VerifyEmailPane (code entry)': () => VerifyEmailPane(
          isLinkPath: false,
          email: 'shahriar.rahman.chowdhury@diu.edu.bd',
          lane: 'inline',
          error: null,
