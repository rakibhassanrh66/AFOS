...
--
-- SUPERSEDED IMMEDIATELY by 20260822004016, which fixes club_members.member_id.
-- Kept because the ledger records it and the tree must match the ledger.
...
begin
  ...
  return jsonb_build_object(
    ...
    'mylabs',      labs,
    'byDay',       byday,
    'clubs',       (select count(*) from club_members  cm where cm.profile_id = me.id),
